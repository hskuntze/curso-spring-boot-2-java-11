package com.KuntzeProjects.course.config;
...
import com.KuntzeProjects.course.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		//Category Seeding - Independent class
		...
		//Association between Products and it's Category(ies)
		...
		productRepository.saveAll(Arrays.asList(p1,p2,p3,p4,p5)); //Saving Products with it's moddifications 
